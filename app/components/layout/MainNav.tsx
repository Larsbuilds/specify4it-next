...
const components: { title: string; href: string; description: string }[] = [
  {
    title: "Features",
    href: "#features",
    description: "Explore our powerful features and capabilities.",
  },
  {
    title: "Pricing",
    href: "#pricing",
    ...
    <NavigationMenu className="hidden md:flex">
      <NavigationMenuList>
        <NavigationMenuItem>
          ...
          <NavigationMenuContent className="absolute top-0 left-0 w-full md:w-auto bg-background border rounded-md shadow-md">
            <ul className="grid gap-3 p-4 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
              ...
              <ListItem href="#quick-start" title="Quick Start">
                Get started building your modern website in minutes.
              </ListItem>
        ...
        <NavigationMenuItem>
          <NavigationMenuLink className={cn(navigationMenuTriggerStyle(), "h-9")} href="#contact">
            Contact
          </NavigationMenuLink>
        </NavigationMenuItem>
      </NavigationMenuList>
